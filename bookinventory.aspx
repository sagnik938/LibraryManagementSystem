                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col">
                                <center>
                                    <img id="imgview" width="100px" src="Images/imgs/books.png" />
                                </center>
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="col">
                                <asp:HyperLink ID="fileLink" runat="server" Text="Download Image" Target="_blank" Visible="False" />
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-3">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:elibraryDBConnectionString %>" SelectCommand="SELECT [publisher_id], [publisher_name] FROM [publisher_master_tbl]"></asp:SqlDataSource>
                                    <asp:DropDownList class="form-control" ID="DropDownList2" DataSourceID="SqlDataSource2"
                                        DataTextField="publisher_name" DataValueField="publisher_id" runat="server">
                                    </asp:DropDownList>
                                </div>
                            </div>
                            <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:elibraryDBConnectionString %>" SelectCommand="SELECT [author_name], [author_id] FROM [author_master_tbl]"></asp:SqlDataSource>
                                    <asp:DropDownList class="form-control" ID="DropDownList3" DataSourceID="SqlDataSource3"
                                        DataTextField="author_name" DataValueField="author_id" runat="server" runat="server">
                                    </asp:DropDownList>
                                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-4 d-grid gap-2">
                                <br />
                                <asp:Button ID="Button3" class="btn btn-block btn-warning" runat="server" Text="Update" Enabled="False" OnClick="Button3_Click" />
                            </div>
                            <div class="col-4 d-grid gap-2">
                                <br />
                                <asp:Button ID="Button2" class="btn btn-block btn-danger" runat="server" Text="Delete" Enabled="False" OnClick="Button2_Click" />
                            </div>
                        </div>
                    </div>
                </div>
